  ...
  module ForensicsIdentifyFileRunner
    ...
    def classify_decision(result)
      ...
      if single_candidate_population &&
        ...
        result["meta"] ||= {}
        result["meta"]["decision_reason"] = "v9_single_candidate_likely_guardrails_passed"
        return "likely_match"
      end
      ...
      evidence_gap = result.dig("meta", "shortlist_evidence_gap").to_f
      evidence_gap = top_cand["evidence_score"].to_f - second_cand["evidence_score"].to_f if evidence_gap <= 0.0 && second_cand.present?
      ...
      if !single_candidate_population &&
           ...
           top_cand["evidence_score"].to_f >= thresholds[:v9_min_evidence_likely_multi_candidate].to_f &&
           evidence_gap >= thresholds[:v9_min_evidence_gap_likely_multi_candidate].to_f &&
           rank_gap >= thresholds[:v9_min_rank_gap_likely_multi_candidate].to_f &&
           top_cand["evidence_consistent_chunks"].to_i >= thresholds[:v9_min_consistent_chunks_likely_multi_candidate].to_i
        result["meta"] ||= {}
        result["meta"]["decision_reason"] = "v9_multi_candidate_weighted_evidence_guardrails_passed"
        return "likely_match"
      end
