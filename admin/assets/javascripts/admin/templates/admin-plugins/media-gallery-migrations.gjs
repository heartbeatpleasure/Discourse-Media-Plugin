      ...
      <section class="mg-migrations__panel">
        ...
        <div class="mg-migrations__filters-footer">
          ...
          <div class="mg-migrations__filters-actions">
            ...
            <button class="btn" type="button" {{on "click" @controller.bulkMigrate}} disabled={{@controller.bulkMigrateDisabled}}>
              {{if @controller.isBulkMigrating "Queueing…" "Bulk migrate results"}}
            </button>
          </div>
        </div>
        ...
        <section class="mg-migrations__panel">
          <div class="mg-migrations__panel-header">
            <div class="mg-migrations__panel-copy">
              ...
              <span class="mg-migrations__muted">Select an item to load a dry-run plan and current diagnostics.</span>
            </div>
          </div>
