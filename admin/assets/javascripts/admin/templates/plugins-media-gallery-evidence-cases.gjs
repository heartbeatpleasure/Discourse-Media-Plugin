      ...
      {{else}}
        ...
        <div class="mg-ev-workflow-content">
          ...
          {{#if (eq @controller.activeStep "reports")}}
            <section class="mg-ev-panel">
              <div class="mg-ev-section-intro"><h2>6. Reports & packages</h2><p class="mg-ev-meta">Generate a reviewable draft at any time. Final reports use the configured PDF profile; packages can optionally add CMS certificate trust and a locally verified RFC 3161 timestamp without assuming any qualified-provider scheme.</p></div>
