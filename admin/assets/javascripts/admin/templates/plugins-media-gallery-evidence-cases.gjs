...
export default RouteTemplate(
  <template>
    <style>
      ...
      .mg-ev-info { display:inline-grid; place-items:center; width:1.35rem; height:1.35rem; min-width:1.35rem; min-height:1.35rem; padding:0; margin:0; border-radius:999px; border:1px solid var(--primary-low-mid); background:var(--primary-very-low); color:var(--primary-high); font-size:var(--font-down-1); font-weight:700; line-height:1; cursor:help; box-shadow:none; flex:0 0 auto; }
      .mg-ev-info:hover, .mg-ev-info:focus-visible, .mg-ev-info[aria-expanded="true"] { border-color:var(--tertiary); background:var(--tertiary-low); color:var(--tertiary); outline:none; }
    ...
    <div class="mg-evidence">
      ...
      <section class="mg-ev-panel">
        <div class="mg-ev-head is-start">
          <div class="mg-ev-section-intro"><div class="mg-ev-title-with-help"><h2>Safety profile</h2><button class="mg-ev-info" type="button" aria-label="Help for Safety profile" aria-expanded={{eq @controller.activeHelpKey "safety_profile"}} aria-controls="mg-ev-help-overlay" {{on "click" (fn @controller.toggleHelp "safety_profile")}}>i</button></div><p class="mg-ev-meta">Restricted identity annexes are not included in standard exports. External source URLs are recorded manually and are never fetched automatically by the server.</p></div>
        ...
        <div class="mg-ev-index-grid">
          ...
          <section class="mg-ev-panel">
            ...
            <form class="mg-ev-form" {{on "submit" @controller.createCase}}>
              <div class="mg-ev-field"><div class="mg-ev-field-label"><label for="mg-ev-new-media-public-id">Media public ID</label><button class="mg-ev-info" type="button" aria-label="Help for Media public ID" aria-expanded={{eq @controller.activeHelpKey "media_public_id"}} aria-controls="mg-ev-help-overlay" {{on "click" (fn @controller.toggleHelp "media_public_id")}}>i</button></div><input id="mg-ev-new-media-public-id" value={{@controller.newMediaPublicId}} {{on "input" (fn @controller.setField "newMediaPublicId")}} /></div>
              <div class="mg-ev-field"><div class="mg-ev-field-label"><label for="mg-ev-new-claimant-ref">Claimant reference</label><button class="mg-ev-info" type="button" aria-label="Help for Claimant reference" aria-expanded={{eq @controller.activeHelpKey "claimant_reference"}} aria-controls="mg-ev-help-overlay" {{on "click" (fn @controller.toggleHelp "claimant_reference")}}>i</button></div><input id="mg-ev-new-claimant-ref" required value={{@controller.newClaimantRef}} {{on "input" (fn @controller.setField "newClaimantRef")}} /></div>
              <div class="mg-ev-field is-full"><div class="mg-ev-field-label"><label for="mg-ev-new-research-question">Research question</label><button class="mg-ev-info" type="button" aria-label="Help for Research question" aria-expanded={{eq @controller.activeHelpKey "research_question"}} aria-controls="mg-ev-help-overlay" {{on "click" (fn @controller.toggleHelp "research_question")}}>i</button></div><textarea id="mg-ev-new-research-question" required value={{@controller.newResearchQuestion}} {{on "input" (fn @controller.setField "newResearchQuestion")}}></textarea></div>
              <div class="mg-ev-field is-full"><div class="mg-ev-field-label"><label for="mg-ev-new-external-url">External URL</label><button class="mg-ev-info" type="button" aria-label="Help for External URL" aria-expanded={{eq @controller.activeHelpKey "external_url"}} aria-controls="mg-ev-help-overlay" {{on "click" (fn @controller.toggleHelp "external_url")}}>i</button></div><input id="mg-ev-new-external-url" type="url" value={{@controller.newExternalUrl}} {{on "input" (fn @controller.setField "newExternalUrl")}} /></div>
              <div class="mg-ev-field"><div class="mg-ev-field-label"><label for="mg-ev-new-external-platform">External platform</label><button class="mg-ev-info" type="button" aria-label="Help for External platform" aria-expanded={{eq @controller.activeHelpKey "external_platform"}} aria-controls="mg-ev-help-overlay" {{on "click" (fn @controller.toggleHelp "external_platform")}}>i</button></div><input id="mg-ev-new-external-platform" value={{@controller.newExternalPlatform}} {{on "input" (fn @controller.setField "newExternalPlatform")}} /></div>
              <div class="mg-ev-field"><div class="mg-ev-field-label"><label for="mg-ev-new-external-username">Visible external username</label><button class="mg-ev-info" type="button" aria-label="Help for Visible external username" aria-expanded={{eq @controller.activeHelpKey "external_username"}} aria-controls="mg-ev-help-overlay" {{on "click" (fn @controller.toggleHelp "external_username")}}>i</button></div><input id="mg-ev-new-external-username" value={{@controller.newExternalUsername}} {{on "input" (fn @controller.setField "newExternalUsername")}} /></div>
              <div class="mg-ev-field"><div class="mg-ev-field-label"><label for="mg-ev-new-rights-statement-ref">Rights statement reference</label><button class="mg-ev-info" type="button" aria-label="Help for Rights statement reference" aria-expanded={{eq @controller.activeHelpKey "rights_statement_reference"}} aria-controls="mg-ev-help-overlay" {{on "click" (fn @controller.toggleHelp "rights_statement_reference")}}>i</button></div><input id="mg-ev-new-rights-statement-ref" value={{@controller.newRightsStatementRef}} {{on "input" (fn @controller.setField "newRightsStatementRef")}} /></div>
              <div class="mg-ev-field"><div class="mg-ev-field-label"><label for="mg-ev-new-rights-statement-received">Rights statement received (local time)</label><button class="mg-ev-info" type="button" aria-label="Help for Rights statement received" aria-expanded={{eq @controller.activeHelpKey "rights_statement_received"}} aria-controls="mg-ev-help-overlay" {{on "click" (fn @controller.toggleHelp "rights_statement_received")}}>i</button></div><input id="mg-ev-new-rights-statement-received" type="datetime-local" value={{@controller.newRightsStatementReceivedAt}} {{on "input" (fn @controller.setField "newRightsStatementReceivedAt")}} /></div>
        ...
        <div class="mg-ev-workflow-content">
          {{#if (eq @controller.activeStep "intake")}}
            <section class="mg-ev-panel">
              ...
              <form class="mg-ev-form" {{on "submit" @controller.saveCase}}>
                <div class="mg-ev-field"><div class="mg-ev-field-label"><label for="mg-ev-edit-claimant-ref">Claimant reference</label><button class="mg-ev-info" type="button" aria-label="Help for Claimant reference" aria-expanded={{eq @controller.activeHelpKey "claimant_reference"}} aria-controls="mg-ev-help-overlay" {{on "click" (fn @controller.toggleHelp "claimant_reference")}}>i</button></div><input id="mg-ev-edit-claimant-ref" required value={{@controller.editClaimantRef}} disabled={{not @controller.selectedMutable}} {{on "input" (fn @controller.setField "editClaimantRef")}} /></div>
                <div class="mg-ev-field"><div class="mg-ev-field-label"><label for="mg-ev-edit-classification">Classification</label><button class="mg-ev-info" type="button" aria-label="Help for Classification" aria-expanded={{eq @controller.activeHelpKey "classification"}} aria-controls="mg-ev-help-overlay" {{on "click" (fn @controller.toggleHelp "classification")}}>i</button></div><select id="mg-ev-edit-classification" value={{@controller.editClassification}} disabled={{not @controller.selectedMutable}} {{on "change" (fn @controller.setField "editClassification")}}><option value="confidential">Confidential</option><option value="restricted">Restricted</option></select></div>
                <div class="mg-ev-field is-full"><div class="mg-ev-field-label"><label for="mg-ev-edit-research-question">Research question</label><button class="mg-ev-info" type="button" aria-label="Help for Research question" aria-expanded={{eq @controller.activeHelpKey "research_question"}} aria-controls="mg-ev-help-overlay" {{on "click" (fn @controller.toggleHelp "research_question")}}>i</button></div><textarea id="mg-ev-edit-research-question" class="is-large" required value={{@controller.editResearchQuestion}} disabled={{not @controller.selectedMutable}} {{on "input" (fn @controller.setField "editResearchQuestion")}}></textarea></div>
                <div class="mg-ev-field"><div class="mg-ev-field-label"><label for="mg-ev-edit-jurisdiction">Jurisdiction context</label><button class="mg-ev-info" type="button" aria-label="Help for Jurisdiction context" aria-expanded={{eq @controller.activeHelpKey "jurisdiction_context"}} aria-controls="mg-ev-help-overlay" {{on "click" (fn @controller.toggleHelp "jurisdiction_context")}}>i</button></div><input id="mg-ev-edit-jurisdiction" value={{@controller.editJurisdictionContext}} disabled={{not @controller.selectedMutable}} {{on "input" (fn @controller.setField "editJurisdictionContext")}} /></div>
                <div class="mg-ev-field"><div class="mg-ev-field-label"><label for="mg-ev-edit-external-platform">External platform</label><button class="mg-ev-info" type="button" aria-label="Help for External platform" aria-expanded={{eq @controller.activeHelpKey "external_platform"}} aria-controls="mg-ev-help-overlay" {{on "click" (fn @controller.toggleHelp "external_platform")}}>i</button></div><input id="mg-ev-edit-external-platform" value={{@controller.editExternalPlatform}} disabled={{not @controller.selectedMutable}} {{on "input" (fn @controller.setField "editExternalPlatform")}} /></div>
                <div class="mg-ev-field is-full"><div class="mg-ev-field-label"><label for="mg-ev-edit-external-url">External URL</label><button class="mg-ev-info" type="button" aria-label="Help for External URL" aria-expanded={{eq @controller.activeHelpKey "external_url"}} aria-controls="mg-ev-help-overlay" {{on "click" (fn @controller.toggleHelp "external_url")}}>i</button></div><input id="mg-ev-edit-external-url" type="url" value={{@controller.editExternalUrl}} disabled={{not @controller.selectedMutable}} {{on "input" (fn @controller.setField "editExternalUrl")}} /></div>
                <div class="mg-ev-field"><div class="mg-ev-field-label"><label for="mg-ev-edit-external-username">Visible external username</label><button class="mg-ev-info" type="button" aria-label="Help for Visible external username" aria-expanded={{eq @controller.activeHelpKey "external_username"}} aria-controls="mg-ev-help-overlay" {{on "click" (fn @controller.toggleHelp "external_username")}}>i</button></div><input id="mg-ev-edit-external-username" value={{@controller.editExternalUsername}} disabled={{not @controller.selectedMutable}} {{on "input" (fn @controller.setField "editExternalUsername")}} /></div>
                <div class="mg-ev-field"><div class="mg-ev-field-label"><label for="mg-ev-edit-observed-at">Observed by staff (local time)</label><button class="mg-ev-info" type="button" aria-label="Help for Observed by staff" aria-expanded={{eq @controller.activeHelpKey "observed_by_staff"}} aria-controls="mg-ev-help-overlay" {{on "click" (fn @controller.toggleHelp "observed_by_staff")}}>i</button></div><input id="mg-ev-edit-observed-at" type="datetime-local" value={{@controller.editExternalObservedAt}} disabled={{not @controller.selectedMutable}} {{on "input" (fn @controller.setField "editExternalObservedAt")}} /></div>
                <div class="mg-ev-field"><div class="mg-ev-field-label"><label for="mg-ev-edit-platform-time">Platform-displayed date/time</label><button class="mg-ev-info" type="button" aria-label="Help for Platform-displayed date and time" aria-expanded={{eq @controller.activeHelpKey "platform_displayed_datetime"}} aria-controls="mg-ev-help-overlay" {{on "click" (fn @controller.toggleHelp "platform_displayed_datetime")}}>i</button></div><input id="mg-ev-edit-platform-time" value={{@controller.editExternalDisplayedAt}} disabled={{not @controller.selectedMutable}} {{on "input" (fn @controller.setField "editExternalDisplayedAt")}} /></div>
                <div class="mg-ev-field"><div class="mg-ev-field-label"><label for="mg-ev-edit-rights-received">Rights statement received (local time)</label><button class="mg-ev-info" type="button" aria-label="Help for Rights statement received" aria-expanded={{eq @controller.activeHelpKey "rights_statement_received"}} aria-controls="mg-ev-help-overlay" {{on "click" (fn @controller.toggleHelp "rights_statement_received")}}>i</button></div><input id="mg-ev-edit-rights-received" type="datetime-local" value={{@controller.editRightsStatementReceivedAt}} disabled={{not @controller.selectedMutable}} {{on "input" (fn @controller.setField "editRightsStatementReceivedAt")}} /></div>
                <div class="mg-ev-field is-full"><div class="mg-ev-field-label"><label for="mg-ev-edit-rights-ref">Rights statement reference</label><button class="mg-ev-info" type="button" aria-label="Help for Rights statement reference" aria-expanded={{eq @controller.activeHelpKey "rights_statement_reference"}} aria-controls="mg-ev-help-overlay" {{on "click" (fn @controller.toggleHelp "rights_statement_reference")}}>i</button></div><input id="mg-ev-edit-rights-ref" value={{@controller.editRightsStatementRef}} disabled={{not @controller.selectedMutable}} {{on "input" (fn @controller.setField "editRightsStatementRef")}} /></div>
          ...
          {{#if (eq @controller.activeStep "evidence")}}
            <section class="mg-ev-panel">
              ...
              <form class="mg-ev-form is-upload" {{on "submit" @controller.uploadObject}}>
                <div class="mg-ev-field"><div class="mg-ev-field-label"><label for="mg-ev-upload-role">Evidence role</label><button class="mg-ev-info" type="button" aria-label="Help for Evidence role" aria-expanded={{eq @controller.activeHelpKey "evidence_role"}} aria-controls="mg-ev-help-overlay" {{on "click" (fn @controller.toggleHelp "evidence_role")}}>i</button></div><select id="mg-ev-upload-role" value={{@controller.uploadRole}} disabled={{not @controller.selectedMutable}} {{on "change" (fn @controller.setField "uploadRole")}}><option value="external_original">External original</option><option value="working_copy">Working copy</option><option value="source_screenshot">Source screenshot</option><option value="source_html">Source HTML</option><option value="source_warc">Source WARC</option><option value="source_headers">Source headers</option><option value="rights_statement">Rights statement</option><option value="other">Other</option></select></div>
                <div class="mg-ev-field"><div class="mg-ev-field-label"><label for="mg-ev-upload-file">File</label><button class="mg-ev-info" type="button" aria-label="Help for Evidence file" aria-expanded={{eq @controller.activeHelpKey "evidence_file"}} aria-controls="mg-ev-help-overlay" {{on "click" (fn @controller.toggleHelp "evidence_file")}}>i</button></div><input id="mg-ev-upload-file" type="file" required disabled={{not @controller.selectedMutable}} {{on "change" @controller.setUploadFile}} /></div>
                <div class="mg-ev-field is-full"><div class="mg-ev-field-label"><label for="mg-ev-upload-description">Description</label><button class="mg-ev-info" type="button" aria-label="Help for Evidence description" aria-expanded={{eq @controller.activeHelpKey "evidence_description"}} aria-controls="mg-ev-help-overlay" {{on "click" (fn @controller.toggleHelp "evidence_description")}}>i</button></div><input id="mg-ev-upload-description" value={{@controller.uploadDescription}} disabled={{not @controller.selectedMutable}} {{on "input" (fn @controller.setField "uploadDescription")}} /></div>
            ...
            <section class="mg-ev-panel">
              ...
              {{#if @controller.selectedIdentify}}
                <div class="mg-ev-stat-grid">
                  <div class="mg-ev-stat"><div class="mg-ev-stat-label"><span class="mg-ev-meta">Decision</span><button class="mg-ev-info" type="button" aria-label="Help for Identify decision" aria-expanded={{eq @controller.activeHelpKey "identify_decision"}} aria-controls="mg-ev-help-overlay" {{on "click" (fn @controller.toggleHelp "identify_decision")}}>i</button></div><strong>{{@controller.selectedIdentify.decision_label}}</strong></div>
                  <div class="mg-ev-stat"><div class="mg-ev-stat-label"><span class="mg-ev-meta">Attributed distribution account</span><button class="mg-ev-info" type="button" aria-label="Help for Attributed distribution account" aria-expanded={{eq @controller.activeHelpKey "attributed_account"}} aria-controls="mg-ev-help-overlay" {{on "click" (fn @controller.toggleHelp "attributed_account")}}>i</button></div><strong>{{@controller.selectedIdentify.attributed_username}}</strong><span class="mg-ev-code">{{@controller.selectedIdentify.attributed_account_ref}}</span></div>
                  <div class="mg-ev-stat"><div class="mg-ev-stat-label"><span class="mg-ev-meta">Candidate population</span><button class="mg-ev-info" type="button" aria-label="Help for Candidate population" aria-expanded={{eq @controller.activeHelpKey "candidate_population"}} aria-controls="mg-ev-help-overlay" {{on "click" (fn @controller.toggleHelp "candidate_population")}}>i</button></div><strong>{{@controller.selectedIdentify.candidate_population_count}}</strong><span class="mg-ev-meta">{{@controller.selectedIdentify.run_kind_label}} candidates</span></div>
                </div>
                <div class="mg-ev-row is-verified"><div class="mg-ev-title-with-help"><strong>Immutable identify snapshot attached</strong><button class="mg-ev-info" type="button" aria-label="Help for Immutable identify snapshot" aria-expanded={{eq @controller.activeHelpKey "identify_snapshot"}} aria-controls="mg-ev-help-overlay" {{on "click" (fn @controller.toggleHelp "identify_snapshot")}}>i</button></div><span>Run {{@controller.selectedIdentify.run_ref}} · Layout {{@controller.selectedIdentify.layout}}</span><span class="mg-ev-code">Raw result SHA-256 {{@controller.selectedIdentify.raw_result_sha256}}</span></div>
              {{else}}
          ...
          {{#if (eq @controller.activeStep "review")}}
            <section class="mg-ev-panel">
              ...
              <div class="mg-ev-subsection">
                <div class="mg-ev-title-with-help"><h3>Claimant confirmation</h3><button class="mg-ev-info" type="button" aria-label="Help for Claimant confirmation" aria-expanded={{eq @controller.activeHelpKey "claimant_confirmation"}} aria-controls="mg-ev-help-overlay" {{on "click" (fn @controller.toggleHelp "claimant_confirmation")}}>i</button></div>
              ...
              <div class="mg-ev-subsection">
                <div class="mg-ev-head"><div><div class="mg-ev-title-with-help"><h3>Technical review checklist</h3><button class="mg-ev-info" type="button" aria-label="Help for Technical review checklist" aria-expanded={{eq @controller.activeHelpKey "technical_review_checklist"}} aria-controls="mg-ev-help-overlay" {{on "click" (fn @controller.toggleHelp "technical_review_checklist")}}>i</button></div><p class="mg-ev-meta">Complete every check for each approval action.</p></div>{{#if @controller.reviewChecklistComplete}}<span class="mg-ev-badge is-ok">Checklist complete</span>{{else}}<span class="mg-ev-badge is-warn">Checklist incomplete</span>{{/if}}</div>
                <div class="mg-ev-checks">
                  {{#each @controller.reviewChecklistItems as |item|}}
                    <div class="mg-ev-check"><label><input type="checkbox" checked={{item.checked}} disabled={{not @controller.selectedMutable}} {{on "change" (fn @controller.setReviewCheck item.key)}} /><span>{{item.label}}</span></label><button class="mg-ev-info" type="button" aria-label={{item.help_label}} aria-expanded={{eq @controller.activeHelpKey item.help_key}} aria-controls="mg-ev-help-overlay" {{on "click" (fn @controller.toggleHelp item.help_key)}}>i</button></div>
                  {{/each}}
                </div>
                <div class="mg-ev-field"><div class="mg-ev-field-label"><label for="mg-ev-review-notes">Internal review reason / notes</label><button class="mg-ev-info" type="button" aria-label="Help for Internal review notes" aria-expanded={{eq @controller.activeHelpKey "internal_review_notes"}} aria-controls="mg-ev-help-overlay" {{on "click" (fn @controller.toggleHelp "internal_review_notes")}}>i</button></div><textarea id="mg-ev-review-notes" class="is-large" value={{@controller.reviewReason}} disabled={{not @controller.selectedMutable}} {{on "input" (fn @controller.setField "reviewReason")}}></textarea><small class="mg-ev-meta">Free text remains internal. External reports and packages contain only a SHA-256 digest indicating that notes existed.</small></div>
          ...
          {{#if (eq @controller.activeStep "administration")}}
            <section class="mg-ev-panel">
              ...
              <div class="mg-ev-stat-grid"><div class="mg-ev-stat"><div class="mg-ev-stat-label"><span class="mg-ev-meta">Retention review due</span><button class="mg-ev-info" type="button" aria-label="Help for Retention review due" aria-expanded={{eq @controller.activeHelpKey "retention_review_due"}} aria-controls="mg-ev-help-overlay" {{on "click" (fn @controller.toggleHelp "retention_review_due")}}>i</button></div><strong>{{@controller.selected.retention_due_at_utc}}</strong><span class="mg-ev-meta">Advisory only; no automatic deletion in this release.</span></div><div class="mg-ev-stat"><div class="mg-ev-stat-label"><span class="mg-ev-meta">Legal hold</span><button class="mg-ev-info" type="button" aria-label="Help for Legal hold" aria-expanded={{eq @controller.activeHelpKey "legal_hold"}} aria-controls="mg-ev-help-overlay" {{on "click" (fn @controller.toggleHelp "legal_hold")}}>i</button></div><strong>{{if @controller.selected.legal_hold "Active" "Not active"}}</strong></div><div class="mg-ev-stat"><div class="mg-ev-stat-label"><span class="mg-ev-meta">Case mutability</span><button class="mg-ev-info" type="button" aria-label="Help for Case mutability" aria-expanded={{eq @controller.activeHelpKey "case_mutability"}} aria-controls="mg-ev-help-overlay" {{on "click" (fn @controller.toggleHelp "case_mutability")}}>i</button></div><strong>{{if @controller.selectedMutable "Mutable" "Immutable"}}</strong></div></div>
              {{#if @controller.config.can_finalize}}<div class="mg-ev-subsection"><div class="mg-ev-title-with-help"><h3>Legal hold</h3><button class="mg-ev-info" type="button" aria-label="Help for Legal hold" aria-expanded={{eq @controller.activeHelpKey "legal_hold"}} aria-controls="mg-ev-help-overlay" {{on "click" (fn @controller.toggleHelp "legal_hold")}}>i</button></div><div class="mg-ev-field"><div class="mg-ev-field-label"><label for="mg-ev-hold-reason">Reason (required)</label><button class="mg-ev-info" type="button" aria-label="Help for Legal hold reason" aria-expanded={{eq @controller.activeHelpKey "legal_hold_reason"}} aria-controls="mg-ev-help-overlay" {{on "click" (fn @controller.toggleHelp "legal_hold_reason")}}>i</button></div><textarea id="mg-ev-hold-reason" class="is-large" value={{@controller.holdReason}} {{on "input" (fn @controller.setField "holdReason")}}></textarea></div><div class="mg-ev-actions">{{#if @controller.selected.legal_hold}}<button class="btn btn-danger" type="button" {{on "click" (fn @controller.setLegalHold false)}}>Release legal hold</button>{{else}}<button class="btn btn-danger" type="button" {{on "click" (fn @controller.setLegalHold true)}}>Place legal hold</button>{{/if}}</div></div>{{/if}}
            </section>
          {{/if}}
        </div>
      {{/unless}}
