...
after_initialize do
  ...
  require_relative "lib/media_gallery/evidence_archival_pdf"
  require_relative "lib/media_gallery/evidence_seal"
  require_relative "lib/media_gallery/evidence_timestamp"
  require_relative "lib/media_gallery/evidence_offline_verifier"
  ...
  require_dependency File.expand_path("app/models/media_gallery/media_comment_report.rb", __dir__)
  ...
  Discourse::Application.routes.append do
    ...
    post "/admin/plugins/media-gallery/media-items/:public_id/aes-key-rotation" => "media_gallery/admin_media_items#rotate_aes_key", defaults: { format: :json }
